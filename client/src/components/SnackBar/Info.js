   ...
   return ( 
      <div className="Info">
         ...
         <section>
            ...
            <p>
               You can filter and search fire departments by clicking on the "Search" button in the lower right corner.  You can also add fire departments to the map by clicking the "Add" button.
            </p>
            <p>
